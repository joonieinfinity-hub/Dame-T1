      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:block">
            <Link to="/reservations" className="bg-[#1ba098] text-[#051622] px-6 py-2 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-[#deb992] hover:shadow-[0_0_15px_rgba(27,160,152,0.4)] transition-all font-lora">Book Now</Link>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-[#deb992] text-sm leading-relaxed mb-6 opacity-80 font-lora italic">Modern British seafood in the heart of Greenwich Village.</p>
            <div className="flex space-x-4">
              <a href={config.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-[#1ba098]/30 flex items-center justify-center text-[#deb992] hover:text-[#051622] hover:bg-[#1ba098] transition-all"><Instagram size={18} /></a>
              <a href={config.facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-[#1ba098]/30 flex items-center justify-center text-[#deb992] hover:text-[#051622] hover:bg-[#1ba098] transition-all"><Facebook size={18} /></a>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-[#deb992] font-lora">
              <li className="flex items-start"><MapPin size={16} className="mr-3 mt-0.5 text-[#1ba098]" /><span className="opacity-80 leading-relaxed">{config.address}</span></li>
              <li className="flex items-center"><Phone size={16} className="mr-3 text-[#1ba098]" /><span className="opacity-80">{config.phone}</span></li>
              <li className="flex items-center"><Mail size={16} className="mr-3 text-[#1ba098]" /><a href={`mailto:${config.email}`} className="opacity-80 hover:text-[#1ba098] transition-colors">{config.email}</a></li>
            </ul>
          </div>
          <div>
            <h4 className="text-[10px] uppercase tracking-[0.3em] font-bold mb-8 text-[#1ba098] font-lora opacity-80">Newsletter</h4>
            <div className="flex group">
              <input type="email" placeholder="Email address" className="bg-[#0a2130] border border-[#1ba098]/30 px-4 py-3 w-full text-sm outline-none text-[#deb992] font-lora placeholder-[#deb992]/30" />
              <button className="bg-[#1ba098] px-5 py-3 hover:bg-[#deb992] transition-colors text-[#051622] flex items-center justify-center"><ArrowRight size={20} /></button>
            </div>
          </div>
        </div>
        <div className="mt-20 pt-8 border-t border-[#1ba098]/10 flex flex-col md:flex-row justify-between items-center text-[10px] uppercase tracking-[0.3em] text-[#deb992] opacity-40 font-lora">
          <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-center">
            ...
            <button onClick={handleStaffToggle} className="flex items-center gap-2 hover:text-[#1ba098] transition-colors group cursor-pointer">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#051622]/95 backdrop-blur-xl animate-in fade-in duration-300">
          <div className="max-w-md w-full bg-[#0a2130] border border-[#1ba098]/30 rounded-[40px] p-12 relative overflow-hidden shadow-2xl">
            ...
            <div className="text-center mb-10">
              <div className="w-16 h-16 bg-[#1ba098]/10 text-[#1ba098] rounded-full flex items-center justify-center mx-auto mb-6"><Lock size={32} /></div>
